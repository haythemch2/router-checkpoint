...
function App() {
  ...
  return (
    <BrowserRouter>
    <div className="App">
      <NavMenu searchcondition={searchcondition} setSearchcondition={setSearchcondition} />
      <Switch>
        <Route path='/home'><Cardcontainer list={moviesList}  Conditionsearch={searchcondition}/></Route>
        <Route path='/movie/:id'><Movies movies={moviesList} /></Route>
        <Route path='/add'><Inputform  MoviesList={moviesList} setMovies={setMoviesList}/></Route>
        <Route path="*"><Cardcontainer list={moviesList}  Conditionsearch={searchcondition}/></Route>
      </Switch>
    </div>
    </BrowserRouter>
  );
